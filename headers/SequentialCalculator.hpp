#ifndef SEQUENTIALCALCULATOR_HPP
#define SEQUENTIALCALCULATOR_HPP
...
class SequentialCalculator:public JuliaSetCalculator {
public:
    SequentialCalculator() :JuliaSetCalculator() {};
